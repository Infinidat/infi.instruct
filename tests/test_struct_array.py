...
def test_fixed_size_array_with_sizer():
    ...
    assert io.write_to_string([ ord('a'), ord('b'), ord('c'), ord('d') ]) == b"abcd"
    assert io.create_from_string(b"abcd") == [ ord('a'), ord('b'), ord('c'), ord('d') ]
...
def test_sum_size_array():
    ...
    assert io.write_to_string([ ord('a'), ord('b'), ord('c'), ord('d') ]) == b"\x00\x04abcd"
    assert io.create_from_string(b"\x00\x04abcd") == [ ord('a'), ord('b'), ord('c'), ord('d') ]
