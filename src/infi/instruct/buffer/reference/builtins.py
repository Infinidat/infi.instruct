from .reference import NumericReferenceMixin
...
class NumericGetAttrReference(GetAttrReference, NumericReferenceMixin):
...
class AssignAttrReference(FuncCallReference):
    ...
    def __init__(self, object, attr_name, value):
        super(AssignAttrReference, self).__init__(lambda obj, attr, val: setattr(obj, attr, val) or val,
...
class NumericAssignAttrReference(AssignAttrReference, NumericReferenceMixin):
